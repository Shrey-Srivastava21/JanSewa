...
export default function NgosCard() {
  return (
    <div className="w-full cursor-pointer  transition-all duration-1000  md:w-5/12 m-4 border hover:shadow-xl rounded px-4 md:flex md:flex-wrap">
      <div className="mb-4 flex  items-center justify-center py-2 ">
        ...
        <div className="flex flex-col mx-2 px-2">
          <h1 className="text-xl md:text-2xl font-semibold">HelpAge India</h1>
          <p className="text-xs sm:text-sm md:text-base text-gray-800 ">
            HelpAge India focuses on the welfare of elderly citizens, providing
            healthcare, livelihood support, and advocating for their rights.
          </p>
        </div>
      </div>
